...
namespace HCP.Pharma.WebAPI.Controllers
{
    ...
    public class CommonDataController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetStoreListByBusinessKey(int BusinessKey, int formId)
        {
            var ds = await _commonDataRepository.GetStoreListByBusinessKey(BusinessKey, formId);
            return Ok(ds);
        }
