            ...
            try
            {
                using (var db = new eSyaEnterprise())
                {
                    var result = await db.GtEpdrfr
                        ...
                        .Join(db.GtEcapcd,
                        tbd => new { ApplicationCode = tbd.t.Dosage },
                        e => new { e.ApplicationCode },
                        (tbd, e) => new { tbd, e })
                        .Join(db.GtEcapcd,
                        tbde => new { ApplicationCode = tbde.tbd.t.DrugForm },
                        f => new { f.ApplicationCode },
                        (tbde, f) => new { tbde, f })
                         .Where(w => w.tbde.tbd.t.DrugFormulation.StartsWith(drugFormulationPrefix != "All" ? drugFormulationPrefix : ""))
                        .Select(a => new DO_DrugFormulation
                        {
                            GenericId = a.tbde.tbd.t.GenericId,
                            GenericDesc = a.tbde.tbd.b.GenericDesc,
                            DrugFormulaID = a.tbde.tbd.t.DrugFormulaId,
                            DrugFormulation = a.tbde.tbd.t.DrugFormulation,
                            
                            Dosage = a.tbde.tbd.t.Dosage,
                            DosageDesc = a.tbde.e.CodeDesc,
                            DrugForm = a.tbde.tbd.t.DrugForm,
                            DrugFormDesc = a.f.CodeDesc,
                            UsageStatus = a.tbde.tbd.t.UsageStatus,
                            ActiveStatus = a.tbde.tbd.t.ActiveStatus
                        }).ToListAsync();
                    return result;
                }
            }
